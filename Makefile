...
all: cmake_check_build_system
	$(CMAKE_COMMAND) -E cmake_progress_start /mnt/d/PID-Control-Project-T2P4/CMakeFiles /mnt/d/PID-Control-Project-T2P4/CMakeFiles/progress.marks
	$(MAKE) -f CMakeFiles/Makefile2 all
	$(CMAKE_COMMAND) -E cmake_progress_start /mnt/d/PID-Control-Project-T2P4/CMakeFiles 0
.PHONY : all
